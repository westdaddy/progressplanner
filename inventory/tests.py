...
class ReferrerDetailViewTests(TestCase):
    ...
    def test_orders_and_stats_for_referrer(self):
        ...
        self.assertEqual(financials["freebie_cost"], Decimal("30.00"))
        self.assertEqual(financials["cost_of_goods_sold"], Decimal("90.00"))
        self.assertEqual(financials["commission"], Decimal("100.00"))
        self.assertEqual(financials["net_profit"], Decimal("20.00"))
